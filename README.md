...
* [English](https://github.com/mbiesiad/awesome-translations) ⭐ 180 | 🐛 0 | 📅 2026-01-18
* [Polish](https://github.com/mbiesiad/awesome-translations/tree/pl_PL) ⭐ 180 | 🐛 0 | 📅 2026-01-18
...
* [LRM](https://github.com/nickprotop/LocalizationManager) ⭐ 38 | 🐛 0 | 🌐 C# | 📅 2026-01-06 - Self-hosted CLI/TUI localization manager supporting .resx and JSON (i18next) with multiple translation providers including free options.
...
* [Traduora](https://github.com/traduora/traduora) ⭐ 2,102 | 🐛 91 | 🌐 JavaScript | 📅 2026-02-07 - A platform to manage translation workflow in teams.
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 17,543 | 🐛 149 | 🌐 TypeScript | 📅 2024-11-29 - An app for Windows, Mac and Linux that automatically translate and adapt a text when copied in the clipboard.
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 13,725 | 🐛 125 | 🌐 Python | 📅 2026-02-08 - 100% Self-Hosted web app to translate text, based on Argos Translate.
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 9,613 | 🐛 25 | 🌐 C++ | 📅 2026-01-15 - A simultaneous translator app for Android based on NLLB and Whisper that runs locally.
...
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 5,636 | 🐛 146 | 🌐 Python | 📅 2026-02-02 - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
* [i18n Ally](https://github.com/antfu/i18n-ally) ⭐ 4,802 | 🐛 464 | 🌐 TypeScript | 📅 2024-12-13 - Extension for VSCode, all in one about i18n.
* [Translator](https://github.com/UlionTse/translators) ⭐ 2,915 | 🐛 11 | 🌐 Python | 📅 2026-01-26 - A translator library based on the translation interface of Google, Yandex, Microsoft (Bing), Baidu, Alibaba, Tencent, NetEase (Youdao), Sogou, Deepl, etc.
* [deep-translator](https://github.com/nidhaloff/deep-translator) ⭐ 1,948 | 🐛 61 | 🌐 Python | 📅 2024-07-23 - A flexible free and unlimited (depending on the translator used) library written in Python to translate between different languages in a simple way using multiple translators, it can also be used directly in the prompt.
* [Translate](https://github.com/translate/translate) ⭐ 938 | 🐛 278 | 🌐 Python | 📅 2026-02-06 - A set of software and documentation designed to help make the lives of localizers both more productive and less frustrating.
* [Polyglot](https://github.com/untra/polyglot) ⭐ 484 | 🐛 17 | 🌐 Ruby | 📅 2026-02-02 - A fast, painless, open-source internationalization plugin for Jekyll blogs.
* [sphinx-intl](https://github.com/sphinx-doc/sphinx-intl) ⭐ 81 | 🐛 13 | 🌐 Python | 📅 2026-02-01 - A Sphinx utility that make it easy to translate and to apply translations.
...
* [attranslate](https://github.com/fkirc/attranslate) ⭐ 350 | 🐛 8 | 🌐 TypeScript | 📅 2025-09-16 - A tool for semi-automated translations of cross-platform apps or websites.
...
* [Pootle](https://github.com/translate/pootle) ⭐ 1,508 | 🐛 524 | 🌐 Python | 📅 2024-08-26 - An online translation management tool with a translation interface focused on localization of applications' graphical user interfaces. It is used by LibreOffice.
