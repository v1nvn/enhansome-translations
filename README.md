...
* [English](https://github.com/mbiesiad/awesome-translations) ⭐ 183 | 🐛 5 | 📅 2026-01-18
* [Polish](https://github.com/mbiesiad/awesome-translations/tree/pl_PL) ⭐ 183 | 🐛 5 | 📅 2026-01-18
* [Italian](https://github.com/niedev/awesome-translations/tree/it_IT) ⭐ 9 | 🐛 1 | 📅 2024-06-27
...
* [LRM](https://github.com/nickprotop/LocalizationManager) ⭐ 46 | 🐛 2 | 🌐 C# | 📅 2026-05-19 - Self-hosted CLI/TUI localization manager supporting .resx and JSON (i18next) with multiple translation providers including free options.
...
* [Traduora](https://github.com/traduora/traduora) ⭐ 2,119 | 🐛 109 | 🌐 JavaScript | 📅 2026-04-08 - A platform to manage translation workflow in teams.
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 17,597 | 🐛 124 | 🌐 TypeScript | 📅 2026-02-23 - An app for Windows, Mac and Linux that automatically translate and adapt a text when copied in the clipboard.
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 14,412 | 🐛 121 | 🌐 Python | 📅 2026-05-05 - 100% Self-Hosted web app to translate text, based on Argos Translate.
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 10,015 | 🐛 26 | 🌐 C++ | 📅 2026-05-21 - A simultaneous translator app for Android based on NLLB and Whisper that runs locally.
...
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,063 | 🐛 153 | 🌐 Python | 📅 2026-04-25 - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
* [i18n Ally](https://github.com/antfu/i18n-ally) ⭐ 4,865 | 🐛 475 | 🌐 TypeScript | 📅 2024-12-13 - Extension for VSCode, all in one about i18n.
* [Translator](https://github.com/UlionTse/translators) ⭐ 2,680 | 🐛 11 | 🌐 Python | 📅 2026-01-26 - A translator library based on the translation interface of Google, Yandex, Microsoft (Bing), Baidu, Alibaba, Tencent, NetEase (Youdao), Sogou, Deepl, etc.
* [deep-translator](https://github.com/nidhaloff/deep-translator) ⭐ 2,005 | 🐛 64 | 🌐 Python | 📅 2024-07-23 - A flexible free and unlimited (depending on the translator used) library written in Python to translate between different languages in a simple way using multiple translators, it can also be used directly in the prompt.
* [Translate](https://github.com/translate/translate) ⭐ 953 | 🐛 261 | 🌐 Python | 📅 2026-05-23 - A set of software and documentation designed to help make the lives of localizers both more productive and less frustrating.
...
* [sphinx-intl](https://github.com/sphinx-doc/sphinx-intl) ⭐ 83 | 🐛 12 | 🌐 Python | 📅 2026-04-07 - A Sphinx utility that make it easy to translate and to apply translations.
...
* [Pootle](https://github.com/translate/pootle) ⭐ 1,503 | 🐛 523 | 🌐 Python | 📅 2024-08-26 - An online translation management tool with a translation interface focused on localization of applications' graphical user interfaces. It is used by LibreOffice.
* [SimpleLocalize CLI](https://github.com/simplelocalize/simplelocalize-cli) ⭐ 75 | 🐛 0 | 🌐 Java | 📅 2026-03-17 - A CLI for finding translation keys in project files.
