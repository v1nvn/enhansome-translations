...
* [English](https://github.com/mbiesiad/awesome-translations) ⭐ 182 | 🐛 3 | 📅 2026-01-18
* [Polish](https://github.com/mbiesiad/awesome-translations/tree/pl_PL) ⭐ 182 | 🐛 3 | 📅 2026-01-18
...
* [Traduora](https://github.com/traduora/traduora) ⭐ 2,115 | 🐛 104 | 🌐 JavaScript | 📅 2026-03-29 - A platform to manage translation workflow in teams.
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 17,561 | 🐛 122 | 🌐 TypeScript | 📅 2026-02-23 - An app for Windows, Mac and Linux that automatically translate and adapt a text when copied in the clipboard.
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 14,085 | 🐛 114 | 🌐 Python | 📅 2026-03-20 - 100% Self-Hosted web app to translate text, based on Argos Translate.
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 9,745 | 🐛 25 | 🌐 C++ | 📅 2026-03-30 - A simultaneous translator app for Android based on NLLB and Whisper that runs locally.
...
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 5,809 | 🐛 151 | 🌐 Python | 📅 2026-02-22 - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
* [i18n Ally](https://github.com/antfu/i18n-ally) ⭐ 4,834 | 🐛 475 | 🌐 TypeScript | 📅 2024-12-13 - Extension for VSCode, all in one about i18n.
...
* [deep-translator](https://github.com/nidhaloff/deep-translator) ⭐ 1,984 | 🐛 64 | 🌐 Python | 📅 2024-07-23 - A flexible free and unlimited (depending on the translator used) library written in Python to translate between different languages in a simple way using multiple translators, it can also be used directly in the prompt.
* [Translate](https://github.com/translate/translate) ⭐ 943 | 🐛 271 | 🌐 Python | 📅 2026-03-31 - A set of software and documentation designed to help make the lives of localizers both more productive and less frustrating.
* [Polyglot](https://github.com/untra/polyglot) ⭐ 490 | 🐛 14 | 🌐 Ruby | 📅 2026-03-02 - A fast, painless, open-source internationalization plugin for Jekyll blogs.
* [sphinx-intl](https://github.com/sphinx-doc/sphinx-intl) ⭐ 81 | 🐛 12 | 🌐 Python | 📅 2026-03-29 - A Sphinx utility that make it easy to translate and to apply translations.
...
* [attranslate](https://github.com/fkirc/attranslate) ⭐ 353 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-12 - A tool for semi-automated translations of cross-platform apps or websites.
...
* [Pootle](https://github.com/translate/pootle) ⭐ 1,505 | 🐛 524 | 🌐 Python | 📅 2024-08-26 - An online translation management tool with a translation interface focused on localization of applications' graphical user interfaces. It is used by LibreOffice.
