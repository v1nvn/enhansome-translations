# Awesome Translations [![Awesome](https://awesome.re/badge-flat.svg)](https://awesome.re) with stars
...
* [English](https://github.com/mbiesiad/awesome-translations) ⭐ 181 | 🐛 2 | 📅 2026-01-18
* [Polish](https://github.com/mbiesiad/awesome-translations/tree/pl_PL) ⭐ 181 | 🐛 2 | 📅 2026-01-18
...
* [LRM](https://github.com/nickprotop/LocalizationManager) ⭐ 41 | 🐛 0 | 🌐 C# | 📅 2026-01-06 - Self-hosted CLI/TUI localization manager supporting .resx and JSON (i18next) with multiple translation providers including free options.
...
* [Traduora](https://github.com/traduora/traduora) ⭐ 2,110 | 🐛 94 | 🌐 JavaScript | 📅 2026-03-05 - A platform to manage translation workflow in teams.
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 17,552 | 🐛 120 | 🌐 TypeScript | 📅 2026-02-23 - An app for Windows, Mac and Linux that automatically translate and adapt a text when copied in the clipboard.
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 13,915 | 🐛 112 | 🌐 Python | 📅 2026-03-06 - 100% Self-Hosted web app to translate text, based on Argos Translate.
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 9,680 | 🐛 24 | 🌐 C++ | 📅 2026-03-03 - A simultaneous translator app for Android based on NLLB and Whisper that runs locally.
...
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 5,730 | 🐛 150 | 🌐 Python | 📅 2026-02-22 - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
* [i18n Ally](https://github.com/antfu/i18n-ally) ⭐ 4,817 | 🐛 474 | 🌐 TypeScript | 📅 2024-12-13 - Extension for VSCode, all in one about i18n.
* [Translator](https://github.com/UlionTse/translators) ⭐ 2,990 | 🐛 12 | 🌐 Python | 📅 2026-01-26 - A translator library based on the translation interface of Google, Yandex, Microsoft (Bing), Baidu, Alibaba, Tencent, NetEase (Youdao), Sogou, Deepl, etc.
* [deep-translator](https://github.com/nidhaloff/deep-translator) ⭐ 1,968 | 🐛 63 | 🌐 Python | 📅 2024-07-23 - A flexible free and unlimited (depending on the translator used) library written in Python to translate between different languages in a simple way using multiple translators, it can also be used directly in the prompt.
* [Translate](https://github.com/translate/translate) ⭐ 939 | 🐛 273 | 🌐 Python | 📅 2026-03-09 - A set of software and documentation designed to help make the lives of localizers both more productive and less frustrating.
* [Polyglot](https://github.com/untra/polyglot) ⭐ 488 | 🐛 14 | 🌐 Ruby | 📅 2026-03-02 - A fast, painless, open-source internationalization plugin for Jekyll blogs.
* [sphinx-intl](https://github.com/sphinx-doc/sphinx-intl) ⭐ 82 | 🐛 14 | 🌐 Python | 📅 2026-03-01 - A Sphinx utility that make it easy to translate and to apply translations.
...
* [attranslate](https://github.com/fkirc/attranslate) ⭐ 353 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-12 - A tool for semi-automated translations of cross-platform apps or websites.
* [SwiftGoogleTranslate](https://github.com/maximbilan/SwiftGoogleTranslate) ⭐ 103 | 🐛 0 | 🌐 Swift | 📅 2023-07-20 - A framework to use cloud translation API by Google in Swift.
* [AutoML Translation Documentation](https://cloud.google.com/translate/automl/docs) - AutoML Translation by Google.

### Other tools

* [Globalize](https://github.com/globalizejs/globalize) ⭐ 4,836 | 🐛 150 | 🌐 JavaScript | 📅 2025-09-29 - A JavaScript library for internationalization and localization that leverage the official Unicode CLDR JSON data.
* [Pootle](https://github.com/translate/pootle) ⭐ 1,507 | 🐛 524 | 🌐 Python | 📅 2024-08-26 - An online translation management tool with a translation interface focused on localization of applications' graphical user interfaces. It is used by LibreOffice.
* [SimpleLocalize CLI](https://github.com/simplelocalize/simplelocalize-cli) ⭐ 73 | 🐛 1 | 🌐 Java | 📅 2026-01-26 - A CLI for finding translation keys in project files.
...
* [Awesome New Languages in Machine Translation](https://github.com/slone-nlp/awesome-new-languages-in-machine-translation) ⭐ 21 | 🐛 0 | 📅 2025-12-02 - A list of initiatives for supporting MT (mostly with opensource models) for new languages (mostly lower-resourced ones).
...
Warmly welcome! Kindly go through [Contribution Guidelines](origin/CONTRIBUTING.md) and [Code of Conduct](origin/CODE-OF-CONDUCT.md) first.
