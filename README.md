...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 17,550 | 🐛 120 | 🌐 TypeScript | 📅 2026-02-23 - An app for Windows, Mac and Linux that automatically translate and adapt a text when copied in the clipboard.
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 13,927 | 🐛 112 | 🌐 Python | 📅 2026-03-10 - 100% Self-Hosted web app to translate text, based on Argos Translate.
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 9,684 | 🐛 24 | 🌐 C++ | 📅 2026-03-03 - A simultaneous translator app for Android based on NLLB and Whisper that runs locally.
...
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 5,743 | 🐛 150 | 🌐 Python | 📅 2026-02-22 - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
* [i18n Ally](https://github.com/antfu/i18n-ally) ⭐ 4,819 | 🐛 475 | 🌐 TypeScript | 📅 2024-12-13 - Extension for VSCode, all in one about i18n.
...
* [deep-translator](https://github.com/nidhaloff/deep-translator) ⭐ 1,970 | 🐛 63 | 🌐 Python | 📅 2024-07-23 - A flexible free and unlimited (depending on the translator used) library written in Python to translate between different languages in a simple way using multiple translators, it can also be used directly in the prompt.
* [Translate](https://github.com/translate/translate) ⭐ 940 | 🐛 274 | 🌐 Python | 📅 2026-03-11 - A set of software and documentation designed to help make the lives of localizers both more productive and less frustrating.
...
* [Globalize](https://github.com/globalizejs/globalize) ⭐ 4,835 | 🐛 150 | 🌐 JavaScript | 📅 2025-09-29 - A JavaScript library for internationalization and localization that leverage the official Unicode CLDR JSON data.
