...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 17,582 | 🐛 122 | 🌐 TypeScript | 📅 2026-02-23 - An app for Windows, Mac and Linux that automatically translate and adapt a text when copied in the clipboard.
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 14,282 | 🐛 118 | 🌐 Python | 📅 2026-04-26 - 100% Self-Hosted web app to translate text, based on Argos Translate.
...
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 5,925 | 🐛 148 | 🌐 Python | 📅 2026-04-25 - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
* [Translator](https://github.com/UlionTse/translators) ⭐ 2,729 | 🐛 11 | 🌐 Python | 📅 2026-01-26 - A translator library based on the translation interface of Google, Yandex, Microsoft (Bing), Baidu, Alibaba, Tencent, NetEase (Youdao), Sogou, Deepl, etc.
...
* [Translate](https://github.com/translate/translate) ⭐ 947 | 🐛 273 | 🌐 Python | 📅 2026-05-03 - A set of software and documentation designed to help make the lives of localizers both more productive and less frustrating.
