...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 17,555 | 🐛 121 | 🌐 TypeScript | 📅 2026-02-23 - An app for Windows, Mac and Linux that automatically translate and adapt a text when copied in the clipboard.
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 13,961 | 🐛 112 | 🌐 Python | 📅 2026-03-12 - 100% Self-Hosted web app to translate text, based on Argos Translate.
...
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 5,752 | 🐛 150 | 🌐 Python | 📅 2026-02-22 - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
* [i18n Ally](https://github.com/antfu/i18n-ally) ⭐ 4,822 | 🐛 475 | 🌐 TypeScript | 📅 2024-12-13 - Extension for VSCode, all in one about i18n.
